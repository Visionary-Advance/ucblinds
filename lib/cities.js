...
export const cities = [
  {
    ...
    metaTitle: 'Window Coverings Eugene OR | New Blind Sales & Installation | UCBlinds',
    metaDescription: 'Top-rated window blind sales & installation in Eugene, OR. Free on-site consultation, lifetime cleaning warranty, expert installation. Call 541-343-8000 today!',

    // Hero section
    hero: {
      title: 'Premium Window Coverings for Eugene Properties',
      subtitle: 'Eugene, Oregon',
      description: 'Transform your Eugene property with custom blinds. Professional installation, lifetime cleaning warranty, and unbeatable quality for properties throughout Lane County.',
...

  {
    ...
    // SEO metadata (unique per city)
    metaTitle: 'Window Coverings Bend OR | Custom Blind Sales & Installation | UCBlinds',
    metaDescription: 'Premium window blind sales & installation in Bend, OR. Serving Central Oregon with free on-site consultations, lifetime warranty, and expert installation. Call 541-343-8000!',

    // Hero section
    hero: {
      title: 'Custom Window Coverings for Bend Properties',
      subtitle: 'Bend, Oregon',
      description: 'Bring style and functionality to your Bend property with our premium custom blinds. Expert installation and lifetime cleaning warranty for Central Oregon property owners.',
...

  {
    ...
    // SEO metadata (unique per city)
    metaTitle: 'Window Coverings Springfield OR | Affordable Blind Installation | UCBlinds',
    ...
    hero: {
      ...
      description: 'Quality window treatments for Springfield properties at prices that fit your budget. Professional installation and our exclusive lifetime cleaning warranty included.',
...

  {
    ...
    // SEO metadata (unique per city)
    metaTitle: 'Window Coverings Woodburn OR | Professional Blind Installation | UCBlinds',
    ...
    hero: {
      ...
      description: 'Serving Woodburn and Marion County with premium window treatments. Professional installation, lifetime cleaning warranty, and personalized service for every property.',
