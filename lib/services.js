...
export const services = [
  {
    id: 1,
    slug: 'ultra-sonic-blind-cleaning',
    title: 'Ultra Sonic Blind Cleaning',
   ...
   image: '/Img/Residential_Blind.jpg',
    heroImage: '/Img/Residential_Blinds.jpg',
    process: [
      {
        step: 1,
        title: 'We pick up your blinds from your property',
        description: 'You can either fill out our contact form with the dimensions of your window coverings, or we can come directly to your residential, rental, commercial, or managed property to evaluate your window treatments in person. Whether you have aluminum blinds, fabric shades, vinyl, verticals, or any other type, we\'ll assess them thoroughly. We believe in being upfront and honest—if we can\'t clean them, we\'ll let you know. You can trust that we\'re fully licensed and insured to handle your window treatments with care.',
...
// image: '/Img/window-blinds-repair.png'      }
  ...
  {
    id: 2,
    slug: 'blind-repair-and-installation',
    title: 'Blind Repair & Installation',
   ...
   image: '/Img/window-blind-repair-installation.jpg',
    heroImage: '/Img/Blind_Repair.webp',
    process: [
      {
        step: 1,
  ...
  {
    id: 3,
    slug: 'blind-replacement-and-new-sales',
    title: 'Blind Replacement & New Sales',
     cta:"Schedule Blind Cleaning Pickup",
   ...
   image: '/Img/Blind_Install.webp',
    heroImage: '/Img/Blind_Install.webp',
    process: [
      {
        step: 1,
        title: 'Free Consultation & Measurement',
        description: 'Schedule a free on-site consultation where we\'ll bring samples, discuss your needs, and take precise measurements of your windows. We\'ll help you choose the perfect blinds that match your style, budget, and functional requirements.',
        image: '/Img/window-blinds-repair.png'
      },
      {
        step: 2,
