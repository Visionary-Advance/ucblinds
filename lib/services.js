...
export const services = [
  {
    id: 1,
    slug: 'residential-blinds',
    title: 'Residential Blinds',
    shortDescription: 'Professional blind solutions for your home with expert cleaning, repair, and installation services.',
    heroDescription: 'We have trained, professional, and expert installers to handle any type of window covering installation. UCBlinds will install residential, commercial, do-it-yourself (DYI), purchased from UCBlinds, or whatever you have in mind.',
...
image: '/Img/window-blinds-repair.png'      }
  ...
  },
  {
    ...
    shortDescription: 'Deep cleaning services using state-of-the-art ultrasonic technology for spotless blinds.',
    heroDescription: 'We specialize in deep cleaning all types of window blinds using our state-of-the-art ultrasonic cleaning machine with environmentally friendly solutions. Our process removes years of built-up dust, grime, and allergens, restoring your blinds to like-new condition.',
  image: '/Img/window-blinds-repair.png',
    heroImage: '/Img/window-blinds-repair.png',
    process: [
      {
...
image: '/Img/window-blinds-repair.png'      }
  ...
  },
  {
    ...
    slug: 'blind-quotes',
    title: 'Blind Quotes',
    shortDescription: 'Get free, accurate quotes for cleaning, repair, or new blind installation services.',
    heroDescription: 'Not sure what your project will cost? Request a free, no-obligation quote for any of our services. We provide transparent pricing and detailed estimates so you know exactly what to expect.',
   image: '/Img/window-blinds-repair.png',
    heroImage: '/Img/window-blinds-repair.png',
    process: [
      {
        ...
        description: 'Fill out our simple online form or give us a call with details about your window treatments. Include information about the type of blinds, number of windows, and the service you\'re interested in.',
image: '/Img/window-blinds-repair.png'      },
      {
        step: 2,
        title: 'Schedule Assessment (Optional)',
        description: 'For the most accurate quote, we can schedule a free in-home visit to assess your blinds, take measurements, and discuss your specific needs. This ensures our quote is as precise as possible.',
image: '/Img/window-blinds-repair.png'      },
      {
        step: 3,
        title: 'Receive Detailed Quote',
        description: 'We\'ll provide you with a detailed, itemized quote that breaks down all costs. Our pricing is transparent with no hidden fees, so you know exactly what you\'re paying for.',
image: '/Img/window-blinds-repair.png'      },
      {
        step: 4,
        title: 'Schedule Service',
        description: 'Once you approve the quote, we\'ll work with your schedule to book a convenient time for your service. We\'re flexible and committed to making the process as easy as possible for you.',
image: '/Img/window-blinds-repair.png'      }
    ]
  }
];
