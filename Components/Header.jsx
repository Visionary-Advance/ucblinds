...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="absolute top-[55px] left-0 right-0 z-40 pt-3 px-4 md:px-8">
        <div className="max-w-[1850px] mx-auto">
          ...
          <div className="flex items-center mb-8">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <h1 className="font-montserrat font-bold text-white text-[24px] md:text-[32px]">UCBlinds</h1>
            </div>

            {/* Desktop Navigation - Hidden on mobile */}
            <nav className="hidden lg:flex absolute left-1/2 -translate-x-1/2 items-end gap-6">
              <Link href="/" className="text-white font-inter text-[18px] hover:opacity-80 transition-opacity">
                Home
              </Link>
              <Link href="/services" className="text-white font-inter text-[18px] hover:opacity-80 transition-opacity">
                Services
              </Link>
              <Link href="/about" className="text-white font-inter text-[18px] hover:opacity-80 transition-opacity">
                About
              </Link>
              <Link href="/contact" className="text-white font-inter text-[18px] hover:opacity-80 transition-opacity">
                Contact
              </Link>
            </nav>
