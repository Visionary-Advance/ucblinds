            ...
            return (
              ...
              >
                ...
                `}>
                  ...
                  <p className="font-montserrat text-black/50 text-[12px] text-center mt-2">
                    {isActive ? 'See example above' : 'Hover to preview'}
                  </p>
                </div>

                {/* Floating Image Preview (appears above card) */}
                {isActive && (
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 z-50 pointer-events-none animate-fadeInScale">
