  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-8 sm:py-16 lg:py-20">
        ...
        <p className="font-[family-name:var(--font-roboto)] text-lg sm:text-xl lg:text-xl text-center text-black/80 max-w-3xl mx-auto leading-relaxed">
UC Blinds was founded on a simple idea: quality service, honest value, and lasting
relationships.
From our Springfield base, we’ve served Lane County and surrounding Oregon
communities for years, providing premium window coverings and the region’s most
trusted blind cleaning service.        </p>
      </section>
...
energy efficiency, and design — backed by exceptional customer care.              </p>
      ...
      {/* Our Approach Section - STYLE 3: Bold Title Cards with Divider */}
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
            ...
            <div className="flex-1 text-right mb-auto">
              <h2 className="font-[family-name:var(--font-montserrat)] text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 lg:mb-8 lg:text-left lg:max-w-[369px] lg:me-auto">
                Our Values
              </h2>
              <div className="max-w-3xl lg:text-left lg:me-auto space-y-6">
                {/* Integrity */}
                <div className="border-b border-white/30 pb-5">
                  <h3 className="font-[family-name:var(--font-montserrat)] text-2xl lg:text-3xl font-bold text-white mb-3 text-left">
                    Integrity
                  </h3>
                  <p className="font-[family-name:var(--font-roboto)] text-base lg:text-lg text-white/90 leading-relaxed text-left">
                    Honest recommendations, transparent pricing, and reliable workmanship.
                  </p>
                </div>
                ...
                <div className="border-b border-white/30 pb-5">
                  ...
                  <p className="font-[family-name:var(--font-roboto)] text-base lg:text-lg text-white/90 leading-relaxed text-left">
                    We partner with leading manufacturers and use advanced cleaning technology.
                  </p>
                </div>
                ...
                <div className="border-b border-white/30 pb-5">
                  ...
                  <p className="font-[family-name:var(--font-roboto)] text-base lg:text-lg text-white/90 leading-relaxed text-left">
                    Lifetime support through our exclusive discounted cleaning program.
                  </p>
                </div>
      ...
      <section className="w-full bg-gradient-to-r from-[#357CCE] to-[#9FD7E9] py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-[family-name:var(--font-montserrat)] text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
            Licensed, Insured, &amp; Dedicated to Excellence
          </h2>
          <p className="font-[family-name:var(--font-roboto)] text-lg sm:text-xl text-white/90 mb-2">
            Oregon CCB #226429
          </p>
          <p className="font-[family-name:var(--font-roboto)] text-lg sm:text-xl text-white/90 mb-4">
